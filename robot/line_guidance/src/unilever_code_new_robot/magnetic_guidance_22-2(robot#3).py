                ...
                if self.temp_2 == 0:
                    ...
                    if self.stop_flag == 1:
                        if self.take_pallet == 0:
                            ...
                            print("take_pallet == 1",self.lane_count)
...
#                                        print("self.lane_count_111111111 = ",self.lane_count)   
                            ...
                            if self.dir_sub == 1:
                                if self.count_2 >= 19 and self.count_2 < 25  :
                                    self.vel_pub.publish(0)
                                    self.ste_pub.publish(self.home_value)
                                elif self.count_2 >= 26 and self.count_2 < 36 :
                                    self.vel_pub.publish(0)
                                    self.ste_pub.publish(2000)
                                    self.take_pallet = 3
                                    self.stop_encoder = -(self.t_enc)
                                ...
                                if self.count_2 >= 1 and self.count_2 < 3 :
                                    self.vel_pub.publish(0)
                                    self.ste_pub.publish(self.home_value)
                                elif self.count_2 >= 3 and self.count_2 < 28 :
                                    self.vel_pub.publish(1150)
                                    self.ste_pub.publish(self.home_value)
                                elif self.count_2 >= 28 and self.count_2 < 50 :
                                    self.vel_pub.publish(0)
                                    self.ste_pub.publish(self.home_value)
...
#                                self.angle_controll_front(1250)
                            ...
                            if self.count_front_magss > 12 and self.loss_line_temp_4 == 0  :
...
#                                        self.loss_line_temp_4 = 0 
                            ...
                            if self.dir_sub == 2:
                                ...
                                if self.count_magss > 11:
                                    ...
                                    if self.dir_sub == 2:
                                        self.vel_pub.publish(1200)
                                        self.ste_pub.publish(self.home_value - 230)
                                    else:
                                        self.vel_pub.publish(1200)
                                        self.ste_pub.publish(self.home_value)
                            ...
                            if self.dir_sub == 2:
                                if if self.position(self.mag_ss_front) >= 3 and self.position(self.mag_ss_front) <= 14  and self.no_line_flag_front == 0 :
                                    self.vel_pub.publish(0)
                                    self.ste_pub.publish(self.home_value)
                                    self.take_pallet = 16
                                else:
