...
class PP_PlannerROS : public nav_core::BaseGlobalPlanner {
public:
  
	PP_PlannerROS (ros::NodeHandle &); //this constructor is may be not needed
	PP_PlannerROS ();
	PP_PlannerROS(std::string name, costmap_2d::Costmap2DROS* costmap_ros);
  ...
  vector<int> PP_Planner(int startCell, int goalCell);
