...
TwistToMotors::TwistToMotors()
{
	...
	cmd_vel_sub = n.subscribe("cmd_vel_mux/input/navi",20, &TwistToMotors::twistCallback, this);
	stop_flag_sub = n.subscribe("stop_flag",20, &TwistToMotors::stopCallback,this);
	stop_rad_sub = n.subscribe("line_stop_rad",20, &TwistToMotors::stopRadCallback,this);
	manual_sub = n.subscribe("manual",20, &TwistToMotors::manualCallback,this);
	stop_flag_2_sub = n.subscribe("stop_flag_2",20, &TwistToMotors::stop2Callback,this);
	server_speed_sub = n.subscribe("ctrlRobotDriving",20,&TwistToMotors::serverCallback,this);		
	pub_fmotor = n.advertise<std_msgs::Float32>("fwheel_vtarget", 20);
	pub_smotor = n.advertise<std_msgs::Float32>("swheel_rtarget", 20);
}
